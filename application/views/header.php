  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <!-- clase areolinea -->
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">AREOLINEA <span class="caret"></span></a>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">VUELO <span class="caret"></span></a>
          <ul class="dropdown-menu">
        ...
        <!-- otra clase drop para equipaje -->
            ...
            <!-- otra clase drop para departamento de trabajo -->
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">DEPARTAMENTO TRABAJO <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo site_url('colegios/index'); ?>">Listado</a></li>
                    <li><a href="<?php echo site_url('colegios/nuevo'); ?>">Nuevo</a></li>
